...
y1 = (-b2 + SQRT(b2**2 - 4.d0*a2*c2))/(2.d0*a2)
y2 = (-b2 -SQRT(b2**2 - 4.d0*a2*c2))/(2.d0*a2)
...
z1 = (-b3 + SQRT(b3**2 - 4.q0*a3*c3))/(2.q0*a3)
z2 = (-b3 -SQRT(b3**2 - 4.q0*a3*c3))/(2.q0*a3)

print*, "Precisión cuadruple:"
print*, x1, "----> x1"
print*, x2, "----> x2"
